 ...
 * --------------------------------------------------------------------------
 *     FLPv3L_LAYERCTRL_INT_ENABLE
 *     FLPv3L_LAYERCTRL_MEM_ENABLE
 *     FLPv3L_LAYERCTRL_INT_DEPTH              [Depth of Interrupt Vector]
 *     FLPv3L_LAYERCTRL_MEM_ADDR_WIDTH         [Memory Address Width]
 *     FLPv3L_LAYERCTRL_MEM_STREAM_CHANNELS    [Number of Memory Streaming Channels]
 *     FLPv3L_LAYERCTRL_MEM_USE_SAME_CLOCK
 *     FLPv3L_LAYERCTRL_ARB_SUPPORT
 *     FLPv3L_MBUS_RF_SIZE                     [Number of Registers in MBus RF]
 *     FLPv3L_MBUS_RF_READ_ONLY                [List of MBus RF IDs that are read-only]
 *     FLPv3L_MBUS_RF_EMPTY                    [List of MBus RF IDs that are empty]
 * --------------------------------------------------------------------------
 *      
 *
 * < DESCRIPTION >
 ...
 *             Fixed an error where next_soft_reset_req is used outside FLPv3L_LAYERCTRL_ARB_SUPPORT
 *             Added two compiler directives (FLPv3L_MBUS_RF_READ_ONLY and FLPv3L_MBUS_RF_EMPTY)
 ...
 *             - add FLPv3L_LAYERCTRL_MEM_ENABLE, FLPv3L_LAYERCTRL_INT_ENABLE definition
...
(
    ...
    `ifdef FLPv3L_LAYERCTRL_ARB_SUPPORT
...
`ifdef FLPv3L_LAYERCTRL_MEM_ENABLE
    `define FLPv3L_LAYERCTRL_MEM_OR_INT_ENABLE
`elsif FLPv3L_LAYERCTRL_INT_ENABLE
    `define FLPv3L_LAYERCTRL_MEM_OR_INT_ENABLE
`endif
...
flpv3l_input_stabilizer_layer_ctrl input_stabilizer_layer_ctrl0[LC_INT_DEPTH-1:0]  (
        .clk(CLK),
        .reset(~RESETn_local),
        .a(INT_VECTOR),
...
`ifndef FLPv3L_LAYERCTRL_ARB_SUPPORT
...
reg     RX_PEND_DL2;
`ifndef FLPv3L_LAYERCTRL_MEM_USE_SAME_CLOCK
...
generate
    for (i=0; i<LC_RF_DEPTH; i=i+1) begin : UNPACK_RF_0
        if ( ~`FLPv3L_MBUS_RF_READ_ONLY & ~`FLPv3L_MBUS_RF_EMPTY) begin : UNPACK_RF_1
...
begin
    ...
    case (lc_state)
        ...
        begin
            ...
            `endif
            `ifdef FLPv3L_LAYERCTRL_MEM_OR_INT_ENABLE
            begin
            `endif
...
endmodule // flpv3l_input_stabilizer_layer_ctrl
