...
elaborate $top_level -param "ADDRESS=20'hbbbb2"
...
write -hierarchy -format verilog -output "${top_level}_n2.nl.v"

# Generate Standard Delay Format (SDF) file
write_sdf -context verilog "${top_level}_n2.pt.sdf"
#Write SDC file
write_sdc "${top_level}_n2.sdc"

#Reporting
set rpt_file "${top_level}_n2.dc.rpt"
