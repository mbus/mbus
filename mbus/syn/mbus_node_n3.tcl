...
write -hierarchy -format verilog -output "${top_level}_n3.nl.v"

# Generate Standard Delay Format (SDF) file
write_sdf -context verilog "${top_level}_n3.pt.sdf"
#Write SDC file
write_sdc "${top_level}_n3.sdc"

#Reporting
set rpt_file "${top_level}_n3.dc.rpt"
